---
title: "Peptide Stacks for Weight Loss: GLP-1 Alone vs Combination Approaches"
meta_title: "Peptide Stacks for Weight Loss: 3 Approaches Compared"
meta_description: "Editorial overview of peptide stacking strategies for weight loss. GLP-1 only vs GLP-1 + GH secretagogue vs GLP-1 + BPC-157. Evidence levels for each approach."
target_keyword: "peptide stacks for weight loss"
secondary_keywords: ["weight loss peptide stack", "glp-1 peptide stack", "semaglutide stack", "peptide stacking for fat loss", "best peptide stack weight loss"]
slug: "peptide-stacks-for-weight-loss"
...
[Semaglutide](/peptides/semaglutide) alone produces roughly 15% weight loss over 68 weeks (PMID: [33567185](https://pubmed.ncbi.nlm.nih.gov/33567185/)). [Tirzepatide](/peptides/tirzepatide) -- itself a "stack" of GLP-1 + GIP receptor agonism in a single molecule -- produces roughly 22.5% over 72 weeks (PMID: [35658024](https://pubmed.ncbi.nlm.nih.gov/35658024/)). [Retatrutide](/peptides/retatrutide), a triple agonist, showed 24.2% in just 48 weeks in Phase 2 (PMID: [37351564](https://pubmed.ncbi.nlm.nih.gov/37351564/)).
...
Sources: STEP 1 (PMID: [33567185](https://pubmed.ncbi.nlm.nih.gov/33567185/)), SURMOUNT-1 (PMID: [35658024](https://pubmed.ncbi.nlm.nih.gov/35658024/))
...
- Muscle loss is a documented concern. GLP-1 medications cause weight loss from both fat and lean mass. Studies suggest 25-40% of weight lost may come from lean mass, though the exact ratio varies (see our [GLP-1 muscle loss guide](/blog/glp-1-muscle-loss-what-research-shows) for details).
- GI side effects are common and can be dose-limiting.
- Some people hit a weight loss plateau and want to optimize further.

For a detailed comparison of the two FDA-approved options, see our [semaglutide vs tirzepatide breakdown](/blog/semaglutide-vs-tirzepatide-weight-loss).
...
GH secretagogues do increase growth hormone levels and IGF-1. Tesamorelin, the only FDA-approved option in this category, has demonstrated reductions in visceral fat in its approved indication (PMID: [21507115](https://pubmed.ncbi.nlm.nih.gov/21507115/)). CJC-1295 and ipamorelin have shown GH elevation in human studies, though large-scale fat loss or muscle preservation trials are limited.
...
For more detail on this approach, see our [body recomposition stack](/stacks/body-recomposition-stack) page.
...
[BPC-157](/peptides/bpc-157) has shown gastroprotective properties in animal studies. It reduced gastric lesions from various insults and promoted gut lining repair in multiple preclinical models (PMID: [24368678](https://pubmed.ncbi.nlm.nih.gov/24368678/)). The logic: if BPC-157 protects the gut, it might reduce GLP-1-related GI distress.
...
For a deep dive on this specific combination, see our [BPC-157 and semaglutide together](/blog/bpc-157-and-semaglutide-together) guide. For broader context on GLP-1 stacking, see our [GLP-1 weight loss stack](/stacks/glp1-weight-loss-stack) breakdown.
...
Tirzepatide = GLP-1 + GIP in one molecule.
[Retatrutide](/peptides/retatrutide) = GLP-1 + GIP + glucagon in one molecule.
...
Retatrutide is still in Phase 3 trials and not yet available. But it represents where the field is heading. See our [retatrutide Phase 2 results](/blog/retatrutide-phase-2-results-triple-agonist) breakdown for the full data.

Also worth watching: the [dual agonist fat loss stack](/stacks/dual-agonist-fat-loss-stack) page covers how existing multi-agonists compare to stacking strategies.
...
*This article is for educational purposes only and is not medical advice. Research peptides are not FDA-approved for human use. FDA-approved medications should be used under physician supervision. Always consult a qualified healthcare provider before starting any peptide protocol. See our [full medical disclaimer](/disclaimer).*

## Sources

1. Wilding JPH, et al. Once-Weekly Semaglutide in Adults with Overweight or Obesity (STEP 1). *New England Journal of Medicine*. 2021;384(11):989-1002. PMID: [33567185](https://pubmed.ncbi.nlm.nih.gov/33567185/)
2. Jastreboff AM, et al. Tirzepatide Once Weekly for the Treatment of Obesity (SURMOUNT-1). *New England Journal of Medicine*. 2022;387(4):327-340. PMID: [35658024](https://pubmed.ncbi.nlm.nih.gov/35658024/)
3. Jastreboff AM, et al. Triple-Hormone-Receptor Agonist Retatrutide for Obesity -- A Phase 2 Trial. *New England Journal of Medicine*. 2023;389(6):514-526. PMID: [37351564](https://pubmed.ncbi.nlm.nih.gov/37351564/)
4. Sikiric P, et al. Pentadecapeptide BPC 157 and its effects on a NSAID toxicity model. *Life Sciences*. 2013;93(5-6):224-237. PMID: [24368678](https://pubmed.ncbi.nlm.nih.gov/24368678/)
5. Falutz J, et al. Metabolic effects of a growth hormone-releasing factor in patients with HIV. *New England Journal of Medicine*. 2007;357(23):2359-2370. PMID: [21507115](https://pubmed.ncbi.nlm.nih.gov/21507115/)
