---
title: "Bacteriostatic Water for Peptides: What It Is, How to Use It, and Storage Rules"
meta_title: "Bacteriostatic Water for Peptides: Complete Guide"
meta_description: "Everything about bacteriostatic water for peptides: what it is, why you need it, shelf life after opening, how much to add per vial, and proper storage."
target_keyword: "bacteriostatic water for peptides"
secondary_keywords: ["bac water peptides", "bacteriostatic water shelf life", "how much bac water for peptides", "bac water vs sterile water"]
slug: "bacteriostatic-water-for-peptides-guide"
...
- How much to add per vial depends on the peptide amount and your desired concentration -- use the [BAC water calculator](/tools/bac-water-calculator) for exact measurements
- Store BAC water at room temperature (unopened) or refrigerated (after first puncture)

**Important:** This is not medical advice. The information below is for educational purposes only. Research peptides are not FDA-approved for human use. Always consult a qualified healthcare provider. See our [full medical disclaimer](/disclaimer).
...
The same 28-day rule applies to your reconstituted peptide. Once you mix the peptide powder with BAC water, that reconstituted vial should be used within 28 days and stored in the refrigerator. See our [peptide storage guide](/blog/how-to-store-peptides-properly) for complete storage instructions.
...
1. **How much peptide is in the vial** (typically printed on the label: 2mg, 5mg, 10mg)
2. **Your desired dose per injection** (in mcg or mg)
3. **How easy you want the measurement to be** on your syringe
...
Use the [BAC water calculator](/tools/bac-water-calculator) to find the ideal volume for your specific peptide and dose. Or try the [dosage calculator](/tools/dosage-calculator) to work backwards from your desired dose.
...
1. Draw the calculated amount of BAC water into an insulin syringe
2. Insert the needle through the rubber stopper of the peptide vial
3. **Aim the needle at the inside wall of the vial** -- do not squirt water directly onto the powder
4. Release the water slowly, letting it run down the glass wall
5. Remove the syringe
6. Gently swirl the vial (do not shake)
7. If the powder does not dissolve immediately, refrigerate for 15-30 minutes and check again

The solution should be clear and colorless. Cloudiness, particles, or discoloration means something is wrong. Do not use it.

For the complete step-by-step process, see our [how to reconstitute peptides guide](/blog/how-to-reconstitute-peptides).
...
**Neonates and premature infants:** Benzyl alcohol has been associated with serious adverse events in neonates, including "gasping syndrome." BAC water should never be used in neonates. This is primarily relevant to clinical pharmacy settings and is called out in the USP and FDA labeling (PMID: [7052622](https://pubmed.ncbi.nlm.nih.gov/7052622/)).
...
For exact reconstitution measurements, use the [BAC water calculator](/tools/bac-water-calculator). For the full reconstitution process, read [how to reconstitute peptides](/blog/how-to-reconstitute-peptides).
...
2. Bacteriostatic Water for Injection, USP -- Prescribing Information (Hospira/Pfizer)
3. Gershanik J, et al. "The gasping syndrome and benzyl alcohol poisoning." -- NEJM, 1982 (PMID: [7052622](https://pubmed.ncbi.nlm.nih.gov/7052622/))
4. FDA Guidance: "Inactive Ingredient Search for Approved Drug Products" -- Benzyl Alcohol
5. USP General Chapter 51 -- Antimicrobial Effectiveness Testing
