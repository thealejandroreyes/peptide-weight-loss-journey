---
title: "Retatrutide FDA Approval Timeline: When Will the Triple Agonist Be Available?"
meta_title: "Retatrutide FDA Approval Timeline (2026 Update)"
meta_description: "Current retatrutide FDA approval timeline. Phase 3 trial status, expected review dates, Eli Lilly pipeline strategy, and realistic earliest availability."
target_keyword: "retatrutide FDA approval timeline"
secondary_keywords: ["retatrutide approval date", "when will retatrutide be available", "retatrutide phase 3", "retatrutide eli lilly", "LY3437943 approval"]
slug: "retatrutide-fda-approval-timeline"
...
**Important:** This article is for informational purposes only. It is not medical advice. Retatrutide is an investigational compound not approved by the FDA for any indication. Timelines discussed are estimates based on publicly available information and standard FDA processes. See our [full medical disclaimer](/disclaimer).

---

## Where retatrutide stands right now

As of early 2026, [retatrutide](/peptides/retatrutide) (also known as LY3437943) is in Phase 3 clinical trials. This is the final and most important stage of clinical testing before a company can submit a New Drug Application (NDA) to the FDA.
...
Phase 2 tests efficacy and side effects in a larger group of patients with the target condition. The retatrutide Phase 2 trial, published in the *New England Journal of Medicine* in 2023, enrolled 338 adults with obesity (PMID: [37351564](https://pubmed.ncbi.nlm.nih.gov/37351564/)).
...
The 24.2% average weight loss at the highest dose is the largest effect size ever recorded in a controlled obesity medication trial. For context, [semaglutide](/peptides/semaglutide) showed 14.9% in STEP 1 (PMID: [33567185](https://pubmed.ncbi.nlm.nih.gov/33567185/)), and [tirzepatide](/peptides/tirzepatide) showed 22.5% in SURMOUNT-1 (PMID: [35658024](https://pubmed.ncbi.nlm.nih.gov/35658024/)).
...
Eli Lilly is not developing retatrutide in a vacuum. The company already has [tirzepatide](/peptides/tirzepatide) (Mounjaro for type 2 diabetes, Zepbound for obesity) on the market. This creates an interesting strategic dynamic.
...
**Research peptide market implications.** An FDA-approved triple agonist reduces the rationale for some [peptide stacking strategies](/blog/peptide-stacks-for-weight-loss). Why combine multiple research peptides for body recomposition if a single approved molecule addresses fat loss, energy expenditure, and metabolic health simultaneously?
...
For currently available, FDA-approved options, see our guides on [semaglutide](/peptides/semaglutide) and [tirzepatide](/peptides/tirzepatide), or explore [weight loss goals](/goals/weight-loss) for a broader overview.
...
Retatrutide targets three receptors (GLP-1, GIP, and glucagon) compared to one for [semaglutide](/peptides/semaglutide) (GLP-1) and two for [tirzepatide](/peptides/tirzepatide) (GLP-1 + GIP). The glucagon receptor is the key differentiator -- it increases energy expenditure and drives fat metabolism in the liver. For the full Phase 2 data breakdown, see our [retatrutide Phase 2 results](/blog/retatrutide-phase-2-results-triple-agonist) article.

---

*This article is for educational purposes only and is not medical advice. Retatrutide is an investigational compound not approved by the FDA. Timeline estimates are based on publicly available information and are subject to change. Always consult a qualified healthcare provider for health decisions. See our [full medical disclaimer](/disclaimer).*
