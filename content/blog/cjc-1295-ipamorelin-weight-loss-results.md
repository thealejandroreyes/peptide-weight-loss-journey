---
title: "CJC-1295 and Ipamorelin Weight Loss Results: What the Evidence Actually Supports"
meta_title: "CJC-1295 Ipamorelin Weight Loss Results (2026)"
meta_description: "CJC-1295 and ipamorelin weight loss results explained. GH secretagogue research, realistic expectations, how they compare to GLP-1s, and stack considerations."
target_keyword: "CJC-1295 ipamorelin weight loss results"
secondary_keywords: ["cjc-1295 ipamorelin results", "cjc-1295 ipamorelin weight loss", "growth hormone peptides weight loss"]
slug: "cjc-1295-ipamorelin-weight-loss-results"
...
**Important:** This is not medical advice. CJC-1295 and ipamorelin are research peptides, not FDA-approved medications. The information below summarizes available scientific literature for educational purposes. Consult a qualified healthcare provider before using any peptide. See our [full medical disclaimer](/disclaimer).

---

## Understanding what these peptides are (and are not)

Before discussing results, a fundamental distinction needs to be clear. [CJC-1295](/peptides/cjc-1295) and [ipamorelin](/peptides/ipamorelin) are not in the same category as [semaglutide](/peptides/semaglutide) or [tirzepatide](/peptides/tirzepatide). They work through completely different mechanisms, target different hormonal pathways, and produce different types of outcomes.
...
The foundational pharmacokinetic study (PMID: [16352683](https://pubmed.ncbi.nlm.nih.gov/16352683/)) demonstrated several important findings:
...
Research on ipamorelin (PMID: [27378083](https://pubmed.ncbi.nlm.nih.gov/27378083/)) established several key points:
...
This is a fundamentally different type of result. For someone primarily interested in [scale weight loss](/goals/weight-loss), GLP-1 medications are the stronger option by a wide margin. For someone interested in body composition improvement — losing fat while preserving or building muscle — GH secretagogues may play a supporting role, though the evidence is less robust.
...
For detailed information on the GLP-1 options, see our guides on [semaglutide](/peptides/semaglutide) and [tirzepatide](/peptides/tirzepatide), or our [head-to-head comparison](/compare/semaglutide-vs-tirzepatide).
...
For an overview of peptide stacking strategies, see our [GLP-1 weight loss stack guide](/stacks/glp1-weight-loss-stack).
...
For women over 50 specifically, GH decline compounds the effects of estrogen loss on body composition. Our guide on [peptides for weight loss for females over 50](/blog/peptides-for-weight-loss-for-females-over-50) covers this intersection in detail.
...
1. Teichman SL, et al. Prolonged stimulation of growth hormone (GH) and insulin-like growth factor I secretion by CJC-1295, a long-acting analog of GH-releasing hormone, in healthy adults. *J Clin Endocrinol Metab.* 2006;91(3):799-805. PMID: [16352683](https://pubmed.ncbi.nlm.nih.gov/16352683/)
2. Raun K, et al. Ipamorelin, the first selective growth hormone secretagogue. *Eur J Endocrinol.* 1998;139(5):552-561. PMID: [27378083](https://pubmed.ncbi.nlm.nih.gov/27378083/)
