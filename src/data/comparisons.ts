...
export const comparisons: Comparison[] = [
  ...
  },
  {
    ...
    dimensions: [
      ...
      { name: 'FDA Status', peptideAScore: 'Approved', peptideBScore: 'Approved', peptideCScore: 'Phase 3', notes: 'Semaglutide and tirzepatide available now. Retatrutide expected 2027-2028.', winner: 'tie' },
      ...
      { name: 'Titration Time', peptideAScore: '16 weeks', peptideBScore: '20 weeks', peptideCScore: '16 weeks', notes: 'Time to reach maximum dose. Tirzepatide has more dose steps.', winner: 'tie' },
      { name: 'Liver Fat Reduction', peptideAScore: '30-40%', peptideBScore: '35-55%', peptideCScore: '~81%', notes: 'Retatrutide glucagon receptor drives dramatically better hepatic fat clearance.', winner: 'C' },
      { name: 'CV Outcomes Data', peptideAScore: 'SELECT trial (proven)', peptideBScore: 'SURPASS-CVOT (pending)', peptideCScore: 'None', notes: 'Semaglutide is the only one with proven cardiovascular benefit (20% MACE reduction).', winner: 'A' },
    ],
    verdicts: [
      {
        peptide: 'Semaglutide',
    ...
    faqs: [
      { question: 'Which GLP-1 agonist should I start with?', answer: 'Most doctors start patients with semaglutide or tirzepatide since both are FDA-approved and available. The choice typically depends on insurance coverage, individual health factors, and your primary treatment goal. If cardiovascular protection matters most, semaglutide has the SELECT trial data. If maximum weight loss is the priority, tirzepatide has the edge. Retatrutide is not yet available outside clinical trials.' },
      { question: 'Can I switch from semaglutide to tirzepatide (or vice versa)?', answer: 'Yes. Switching is common and done under medical supervision. The standard protocol is to start the new medication at its lowest dose (2.5 mg for tirzepatide, 0.25 mg for semaglutide) regardless of your previous dose. No washout period is required. Expect to retitrate over several weeks, and some GI side effects may return during the transition.' },
      { question: 'How long does it take to see weight loss results?', answer: 'The first 4 weeks are primarily for GI adjustment at subtherapeutic doses. Most patients notice meaningful appetite changes by weeks 5-8. Significant weight loss typically becomes visible by weeks 8-12 as you approach therapeutic doses. Peak weight loss velocity occurs between weeks 12-24 at maintenance doses.' },
      { question: 'What happens if I stop taking GLP-1 medication?', answer: 'Clinical data shows patients regain approximately two-thirds of their lost weight within one year of stopping. The STEP 1 extension and SURMOUNT-4 withdrawal studies both demonstrated significant weight regain after discontinuation. These medications are designed as long-term treatments for a chronic condition, similar to blood pressure medication.' },
      { question: 'Is retatrutide better than tirzepatide?', answer: 'The Phase 2 data shows similar peak weight loss (24-26% vs 20-26%), but retatrutide achieved it in a shorter timeframe (48 vs 72 weeks) and showed dramatically better liver fat reduction (~81% vs 35-55%). However, retatrutide has only Phase 2 data from 338 patients. Tirzepatide has Phase 3 data from thousands and is FDA-approved. A definitive comparison requires Phase 3 retatrutide results.' },
      { question: 'Will insurance cover these medications?', answer: 'Coverage varies significantly. Semaglutide (Wegovy) has the broadest insurance coverage due to its longer time on market. Tirzepatide (Zepbound) coverage is expanding but still more limited. Medicare Part D does not cover anti-obesity medications as of early 2026. Compounded versions of semaglutide and tirzepatide are available at $150-500/month through compounding pharmacies, though this access may change as FDA shortage designations evolve.' },
      { question: 'What about fatty liver disease? Which is best for NAFLD/MASH?', answer: 'Retatrutide shows the strongest liver fat reduction data: approximately 81% decrease in liver fat at the highest dose, compared to 30-40% for semaglutide and 35-55% for tirzepatide. The glucagon receptor component drives this advantage by promoting hepatic fat oxidation. However, retatrutide is not yet available. Among available options, tirzepatide has a slight edge over semaglutide for liver fat reduction.' },
      { question: 'Do I need to exercise and diet while on GLP-1 medications?', answer: 'Yes. These medications suppress appetite but do not prevent muscle loss or build cardiovascular fitness. Clinical guidelines recommend resistance training at least twice per week and protein intake of 1.0-1.2 grams per kilogram of body weight daily. The medication handles appetite suppression. You handle muscle preservation and overall health.' },
      { question: 'How do the side effects compare?', answer: 'All three cause GI side effects (nausea, vomiting, diarrhea), primarily during dose titration. Tirzepatide appears to cause fewer GI symptoms than semaglutide despite greater weight loss, possibly due to the GIP receptor buffering effect. Retatrutide shows a similar GI profile to tirzepatide but with slightly higher heart rate increases (2-6 bpm vs 2-4 bpm) due to the glucagon component.' },
      { question: 'Will there be even more advanced versions?', answer: 'Yes. Multiple companies are developing quad-agonists and other multi-receptor combinations. The incretin field is advancing rapidly, with several new candidates in clinical trials. The trajectory from single to dual to triple agonist is expected to continue.' },
    ],
    relatedComparisons: ['semaglutide-vs-tirzepatide', 'semaglutide-vs-retatrutide', 'tirzepatide-vs-retatrutide'],
  },
  {
